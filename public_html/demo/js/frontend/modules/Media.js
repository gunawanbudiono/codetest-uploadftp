var Media = {
    ...
    handler :   function(){
        ...
        $(".glyphicon-actived-list").css('color', '#0084bf');
        $(".action-assets-via-table").click(function(){

            $(".glyphicon-actived-list").css('color', '#0084bf');
            $(".glyphicon-actived-img").css('color', '#252525');
         ...
         $(".action-assets-via-gallery").click(function(){
            ...
            $(".glyphicon-actived-list").css('color', '#252525');
            $(".glyphicon-actived-img").css('color', '#0084bf');

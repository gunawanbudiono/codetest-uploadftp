var Pelamar={
    ...
    getStepValidationForPelamar   :   function(p,f){
        var $this = this;                
    ...
    validatePelamar    :   function(f){
        ...
        Pelamar.getStepValidationForPelamar({
             id      :   null,
             step    :   1,
             url     :   Request.Pelamar.postMember(),
             title   :   'Cek akun..'
         },function(){
             ...
             Pelamar.getStepValidationForPelamar({
                 id      :   null,
                 step    :   2,
                 url     :   Request.Pelamar.postPelamar(),
                 ...
                 Pelamar.getStepValidationForPelamar({
                     id      :   null,
                     step    :   3,
                     url     :   Request.Pelamar.postInvoice(),
                     ...
                     Pelamar.getStepValidationForPelamar({
                         id      :   null,
                         step    :   4,
                         url     :   Request.Pelamar.postInvoiceItems(),
                         ...
                         Pelamar.getStepValidationForPelamar({
                             id      :   null,
                             step    :   4,
                             url     :   Request.Pelamar.postPelamarItems(),
